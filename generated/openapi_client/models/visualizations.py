...
class Visualizations(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["visualizations"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Visualizations from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Visualizations from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "visualizations": [Visualization.from_dict(_item) for _item in obj["visualizations"]] if obj.get("visualizations") is not None else None
        })
        return _obj
