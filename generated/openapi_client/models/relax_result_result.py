...
class RelaxResultResult(BaseModel):
    """
    RelaxResultResult
    """ # noqa: E501
    ...
    fits: Optional[RelaxResultResultAllOfFits] = None
    test_results: Optional[RelaxResultResultAllOfTestResults] = Field(default=None, alias="test results")
    __properties: ClassVar[List[str]] = ["analysis", "input", "tested", "timers", "runtime", "data partitions", "fits", "test results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fits": RelaxResultResultAllOfFits.from_dict(obj["fits"]) if obj.get("fits") is not None else None,
            "test results": RelaxResultResultAllOfTestResults.from_dict(obj["test results"]) if obj.get("test results") is not None else None
        })
        return _obj
