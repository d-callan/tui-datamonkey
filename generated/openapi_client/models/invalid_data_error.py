...
class InvalidDataError(BaseModel):
    """
    InvalidDataError
    """ # noqa: E501
    errors: Optional[List[InvalidDataErrorErrorsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errors": [InvalidDataErrorErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
