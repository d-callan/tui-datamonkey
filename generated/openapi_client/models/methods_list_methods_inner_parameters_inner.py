...
class MethodsListMethodsInnerParametersInner(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(default=None, description="Data type of the parameter")
    default: Optional[StrictStr] = Field(default=None, description="Default value of the parameter (if any)")
    __properties: ClassVar[List[str]] = ["name", "description", "required", "type", "default"]
