...
class ContrastFelResultResult(BaseModel):
    """
    ContrastFelResultResult
    """ # noqa: E501
    analysis: Optional[AnalysisInfo] = None
    input: Optional[InputInfo] = None
    tested: Optional[Dict[str, StrictStr]] = Field(default=None, description="Mapping of branch names to their test groups (e.g., \"TREATED\", \"NAIVE\", \"background\")")
    ...
    mle: Optional[ContrastFelResultResultAllOfMLE] = Field(default=None, alias="MLE")
    branch_attributes: Optional[Dict[str, Dict[str, Any]]] = Field(default=None, description="Attributes for each branch in the phylogenetic tree")
    fits: Optional[Dict[str, Dict[str, Any]]] = Field(default=None, description="Model fit statistics")
    __properties: ClassVar[List[str]] = ["analysis", "input", "tested", "timers", "runtime", "data partitions", "MLE", "branch_attributes", "fits"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "MLE": ContrastFelResultResultAllOfMLE.from_dict(obj["MLE"]) if obj.get("MLE") is not None else None,
            "branch_attributes": obj.get("branch_attributes"),
            "fits": obj.get("fits")
        })
        return _obj
