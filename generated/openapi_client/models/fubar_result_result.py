...
class FubarResultResult(BaseModel):
    """
    FubarResultResult
    """ # noqa: E501
    ...
    grid: Optional[List[List[Union[StrictFloat, StrictInt]]]] = Field(default=None, description="Grid points for the Bayesian analysis")
    __properties: ClassVar[List[str]] = ["analysis", "input", "tested", "timers", "runtime", "data partitions", "fits", "MLE", "grid"]
