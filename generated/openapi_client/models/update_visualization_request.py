...
class UpdateVisualizationRequest(BaseModel):
    ...
    """ # noqa: E501
    title: Optional[StrictStr] = Field(default=None, description="Updated title of the visualization")
    description: Optional[StrictStr] = Field(default=None, description="Updated description")
    spec: Optional[Dict[str, Any]] = Field(default=None, description="Updated Vega-Lite visualization specification")
    config: Optional[Dict[str, Any]] = Field(default=None, description="Updated configuration options")
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="Updated metadata")
    __properties: ClassVar[List[str]] = ["title", "description", "spec", "config", "metadata"]
