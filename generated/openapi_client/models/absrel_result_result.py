...
class AbsrelResultResult(BaseModel):
    """
    AbsrelResultResult
    """ # noqa: E501
    ...
    timers: Optional[Dict[str, AbsrelResultResultAllOfTimersValue]] = None
    ...
    fits: Optional[Dict[str, AbsrelResultResultAllOfFitsValue]] = None
    test_results: Optional[AbsrelResultResultAllOfTestResults] = Field(default=None, alias="test results")
    branch_attributes: Optional[AbsrelResultResultAllOfBranchAttributes] = Field(default=None, alias="branch attributes")
    __properties: ClassVar[List[str]] = ["analysis", "input", "tested", "timers", "runtime", "data partitions", "fits", "test results", "branch attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "timers": dict(
                (_k, AbsrelResultResultAllOfTimersValue.from_dict(_v))
            ...
            "fits": dict(
                (_k, AbsrelResultResultAllOfFitsValue.from_dict(_v))
                for _k, _v in obj["fits"].items()
            )
            if obj.get("fits") is not None
            else None,
            "test results": AbsrelResultResultAllOfTestResults.from_dict(obj["test results"]) if obj.get("test results") is not None else None,
            "branch attributes": AbsrelResultResultAllOfBranchAttributes.from_dict(obj["branch attributes"]) if obj.get("branch attributes") is not None else None
        })
        return _obj
