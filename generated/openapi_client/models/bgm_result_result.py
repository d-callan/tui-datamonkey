...
class BgmResultResult(BaseModel):
    """
    BgmResultResult
    """ # noqa: E501
    ...
    fits: Optional[Dict[str, BgmResultResultAllOfFitsValue]] = Field(default=None, description="Model fit information")
    mle: Optional[BgmResultResultAllOfMLE] = Field(default=None, alias="MLE")
    branch_attributes: Optional[Dict[str, Dict[str, Dict[str, Union[StrictFloat, StrictInt]]]]] = Field(default=None, description="Branch-specific attributes", alias="branch attributes")
    __properties: ClassVar[List[str]] = ["analysis", "input", "tested", "timers", "runtime", "data partitions", "fits", "MLE", "branch attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fits": dict(
                (_k, BgmResultResultAllOfFitsValue.from_dict(_v))
                for _k, _v in obj["fits"].items()
            )
            if obj.get("fits") is not None
            else None,
            "MLE": BgmResultResultAllOfMLE.from_dict(obj["MLE"]) if obj.get("MLE") is not None else None,
            "branch attributes": obj.get("branch attributes")
        })
        return _obj
