...
class ChatMessage(BaseModel):
    ...
    """ # noqa: E501
    role: StrictStr = Field(description="Role of the message sender")
    content: StrictStr = Field(description="Content of the message")
    timestamp: Optional[StrictInt] = Field(default=None, description="Timestamp when the message was sent (Unix timestamp in milliseconds)")
    __properties: ClassVar[List[str]] = ["role", "content", "timestamp"]
