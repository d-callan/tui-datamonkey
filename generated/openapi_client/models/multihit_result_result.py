...
class MultihitResultResult(BaseModel):
    """
    ...
    evidence_ratios: Optional[MultihitResultResultAllOfEvidenceRatios] = Field(default=None, alias="Evidence Ratios")
    site_substitutions: Optional[Dict[str, Dict[str, Dict[str, Any]]]] = Field(default=None, description="Detailed site substitution mappings")
    fits: Optional[MultihitResultResultAllOfFits] = None
    test_results: Optional[MultihitResultResultAllOfTestResults] = None
    __properties: ClassVar[List[str]] = ["analysis", "input", "tested", "timers", "runtime", "data partitions", "Evidence Ratios", "site_substitutions", "fits", "test_results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Evidence Ratios": MultihitResultResultAllOfEvidenceRatios.from_dict(obj["Evidence Ratios"]) if obj.get("Evidence Ratios") is not None else None,
            "site_substitutions": obj.get("site_substitutions"),
            "fits": MultihitResultResultAllOfFits.from_dict(obj["fits"]) if obj.get("fits") is not None else None,
            "test_results": MultihitResultResultAllOfTestResults.from_dict(obj["test_results"]) if obj.get("test_results") is not None else None
        })
        return _obj
