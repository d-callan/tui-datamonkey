...
class ListUserConversations200Response(BaseModel):
    """
    ListUserConversations200Response
    """ # noqa: E501
    conversations: Optional[List[ChatConversation]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "conversations": [ChatConversation.from_dict(_item) for _item in obj["conversations"]] if obj.get("conversations") is not None else None
        })
        return _obj
