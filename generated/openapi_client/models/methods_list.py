...
class MethodsList(BaseModel):
    ...
    MethodsList
    """ # noqa: E501
    methods: Optional[List[MethodsListMethodsInner]] = Field(default=None, description="List of available HyPhy methods")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "methods": [MethodsListMethodsInner.from_dict(_item) for _item in obj["methods"]] if obj.get("methods") is not None else None
        })
        return _obj
