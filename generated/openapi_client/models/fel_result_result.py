...
class FelResultResult(BaseModel):
    """
    FelResultResult
    """ # noqa: E501
    ...
    fits: Optional[Dict[str, FelResultResultAllOfFitsValue]] = None
    branch_attributes: Optional[FelResultResultAllOfBranchAttributes] = Field(default=None, alias="branch attributes")
    mle: Optional[FelResultResultAllOfMLE] = Field(default=None, alias="MLE")
    __properties: ClassVar[List[str]] = ["analysis", "input", "tested", "timers", "runtime", "data partitions", "fits", "branch attributes", "MLE"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fits": dict(
                (_k, FelResultResultAllOfFitsValue.from_dict(_v))
                for _k, _v in obj["fits"].items()
            )
            if obj.get("fits") is not None
            else None,
            "branch attributes": FelResultResultAllOfBranchAttributes.from_dict(obj["branch attributes"]) if obj.get("branch attributes") is not None else None,
            "MLE": FelResultResultAllOfMLE.from_dict(obj["MLE"]) if obj.get("MLE") is not None else None
        })
        return _obj
